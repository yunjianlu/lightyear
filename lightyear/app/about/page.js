  ...
  return (
    <main className="mx-auto p-8">
        <div className="flex flex-col md:grid md:grid-cols-1 md:grid-rows-[h-min_h-min]">
            ...
            <section className="space-y-15 md:grid md:grid-rows-5 md:space-y-0 md:col-span-full">
                <div className="flex flex-col md:grid md:grid-cols-5 justify-around mb-15">
                    <div className="md:col-span-2 flex md:items-center 3xl:pl-10">
                        <Image
                            ...
                            width={400}
                            height={200}
                            className="w-full min-h-95 max-h-130 md:max-h-180 md:min-h-min object-contain mb-4 rounded justify-center items-center"
                            />
                    </div>
                    <div className="md:flex md:pl-10 md:content-around md:justify-around md:flex-col md:col-span-3 h-4/6 3xl:px-20">
                        <div>
                            <h2 className="md:text-6xl font-semibold text-center text-2xl mb-2 md:mb-0 3xl:text-8xl">The Sci-Fi Ecommerce Revolution</h2>
                        </div>
                        <div>
                            <p className="md:text-2xl text-md mb-10 md:mb-0 3xl:text-4xl">
                ...
                <div className="flex flex-col md:grid md:grid-cols-5 justify-around mb-15">
                    ...
                    <div className="md:flex md:px-10 md:content-around md:justify-around md:flex-col md:col-span-3 h-4/6 3xl:px-20">
                        <div>
                            <h2 className="md:text-6xl font-semibold text-center text-2xl mb-2 md:mb-0 3xl:text-8xl">Our Mission</h2>
                        </div>
                        <div>
                            <p className="md:text-2xl text-md mb-10 md:mb-0 3xl:text-4xl">
                ...
                <div className="flex flex-col md:grid md:grid-cols-5 justify-around mb-15">
                    ...
                    <div className="md:flex md:pl-10 md:content-around md:justify-around md:flex-col md:col-span-3 h-4/6 3xl:px-20">
                        <div>
                            <h2 className="md:text-6xl font-semibold text-center text-2xl mb-2 md:mb-0 3xl:text-8xl">Our Story</h2>
                        </div>
                        <div>
                            <p className="md:text-2xl text-md mb-10 md:mb-0 3xl:text-4xl">
                ...
                <div className="flex flex-col md:grid md:grid-cols-5 justify-around mb-15">
                    ...
                    <div className="md:flex md:px-10 md:content-around md:justify-around md:flex-col md:col-span-3 h-4/6 3xl:px-20">
                        <div>
                            <h2 className="md:text-6xl font-semibold text-center text-2xl mb-2 md:mb-0 3xl:text-8xl">Why Shop With Us?</h2>
                        </div>
                        <div>
                            <ul className="list-disc list-inside pl-4 space-y-1 md:text-2xl text-md mb-10 md:mb-0 3xl:text-4xl">
                ...
                <div className="grid grid-cols-1 md:justify-around mb-15 md:mb-0 h-screen">
                    <div className="flex md:pl-10 justify-center items-center md:content-around md:justify-around flex-col md:col-span-full">
                        <div>
                            <h2 className="md:text-7xl font-semibold text-center text-4xl mb-10 md:mb-0 3xl:text-9xl">Join the Lightyear Journey</h2>
                        </div>
                        <div>
                            <p className="md:text-2xl text-center text-md 3xl:text-5xl">
